...
public class Brain {
	...
	public void turnToMouse(Cell cell, float value) {

		float angle = PhysicsHandeler.getTargetAngle(cell.getX(), cell.getY(), Mouse.getX(), Main.height-Mouse.getY());

		cell.setRotation(angle-90);
	...
	public void turnToFood(Cell cell, float value) {
		...
		float angle = PhysicsHandeler.getTargetAngle(cell.getX(), cell.getY(), nearestFood.x, nearestFood.y)-90;
	...
	public void turnToCell(Cell cell, float value) {
		...
		float angle = PhysicsHandeler.getTargetAngle(cell.getX(), cell.getY(), nearestSmelledCell.getX(), nearestSmelledCell.getY())-90;
	...
	public static float senseNoiseOfTile(Cell cell) {

		
		int x = (int) ((int)cell.getX() + -30*(float)Math.sin(Math.toRadians(-1*cell.getRotation())))/Main.size;
		int y = (int) (cell.getY() + -30*(float)Math.cos(Math.toRadians(-1*cell.getRotation())))/Main.size;
